...
const BirthdayInvitation = () => {  
    ...
    <div className="container mt-2">  
      <div className="card text-center" id="birthday-invitation">  
        <div className="position-relative">  
          <img  
            src="/img/d5ad3d0c-7f12-459d-a1f6-ad8c195b207e.jpeg"  
          ...
          >  
            <source  
              src="/music/christina perri a thousand years official music video [rtOvBOTyX00].mp3"  
              type="audio/mpeg"  
            />  
  ...
  Hay momentos inolvidables que se atesoran en el corazón para siempre, por esa razón quiero que compartas conmigo este día tan especial.  
          ...
          <Carousel>  
            <Carousel.Item>  
              <img className="d-block w-100" src="/img/c8a6297d-cfc8-4ba5-9783-48cf01f06f1f.jpeg" alt="Foto 1" />  
            </Carousel.Item>  
            <Carousel.Item>  
              <img className="d-block w-100" src="/img/2343b524-58a7-4d6a-88b9-0b28d7bbf700.jpeg" alt="Foto 2" />  
            </Carousel.Item>  
            <Carousel.Item>  
              <img className="d-block w-100" src="/img/c943e4b5-59e9-41af-9b6e-018be5e478c5.jpeg" alt="Foto 3" />  
            </Carousel.Item>  
          </Carousel>  
          ...
          <div className="dress-code mt-3 mx-auto text-center"  
            ...
            <div className="mt-2">   
              <img src="/img/dress-code-icon-27.jpg" alt="Dress Code" style={{ width: '120px', marginTop: '10px' }} />  
            </div>  
          </div>  
        ...
        <div className="position-relative">  
          <img  
            src="/img/1a31c2ee-77e2-41ad-b8d6-137a8857ab18.jpeg"  
